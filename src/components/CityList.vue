<template>
  <!-- 市区町村一覧 -->
  <div class="flex-1 lg:w-1/2 bg-white border-r border-gray-200 flex flex-col max-h-[calc(100vh-200px)] lg:max-h-[calc(100vh-120px)]">
    <div class="p-4 border-b border-gray-200 flex-shrink-0">
      <h3 class="text-lg font-semibold text-gray-900 mb-2">市区町村一覧</h3>
      <div class="text-sm text-gray-600">
        <span class="font-medium text-blue-600">{{ cities.length }}</span>件の市区町村
      </div>
    </div>
    <div class="flex-1 overflow-y-auto min-h-0 max-h-[calc(100vh-280px)] lg:max-h-[calc(100vh-200px)]">
      <div class="p-4">

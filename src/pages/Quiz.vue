    ...
    <div class="max-w-4xl mx-auto px-4">
      ...
      <header class="text-center mb-12">
        <div class="inline-flex items-center justify-center w-16 h-16 bg-purple-100 rounded-full mb-4">
          <svg class="text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width: 32px; height: 32px;">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
          </svg>
        </div>
        <h1 class="text-4xl font-bold text-gray-800 mb-4">自治体クイズ</h1>
        <p class="text-xl text-gray-600">日本の自治体について学んでみましょう</p>
      </header>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
        <div class="text-center py-12">
          <div class="inline-flex items-center justify-center w-20 h-20 bg-gray-100 rounded-full mb-6">
            <svg class="text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width: 40px; height: 40px;">
          ...
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <ul class="text-blue-700 space-y-2 text-left max-w-md mx-auto">
              <li class="flex items-center">
                <svg class="mr-2 text-blue-500" fill="currentColor" viewBox="0 0 20 20" style="width: 16px; height: 16px;">
      ...
      <div class="flex justify-center space-x-4">
        ...
        >
          <svg class="mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width: 20px; height: 20px;">
